...
@section('content')
  ...
  <div class="row">
    <div class="col-sm-8">
       {!!Form::open(array('url' => 'riskmanager/risktask/new','files'=>true,'id'=>'form','class'=>'form-horizontal'))!!}
        ...
        <div class="form-group">
          <div class="col-sm-offset-2 col-sm-10">
            ...
            <a href="{{action('RiskController@indexRiskM')}}"><button type="button" class="btn btn-info">Cancelar</button></a>
          </div>
        </div>
      </form>
    </div>

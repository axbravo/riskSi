...
@section('content')
        <!-- Contenido-->
        <div class="row">
          {!!Form::open(array('url' => 'admin/project' ,'id'=>'form','class'=>'form-horizontal'))!!}
        ...
        <table class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <td>{{$project->cost}}</td>
                <td>{{$project->risk_id}}</td> 
                <td class="button-center"><a class="btn btn-info" href="{{url('admin/project/'.$project->id.'/analyse')}}" title="Detalle" ><i class="glyphicon glyphicon-stats"></i></a>
                </td> 
                <td class="button-center"><a class="btn btn-info" href="{{url('admin/project/'.$project->id.'/subactivities')}}" title="Detalle" ><i class="glyphicon glyphicon-plus"></i></a>
                </td> 
                <td class="button-center"><a class="btn btn-info" href="{{url('admin/project/'.$project->id.'/edit')}}" title="Editar" ><i class="glyphicon glyphicon-pencil"></i></a>
                </td> 
       ...
       <!--{{$project->runCheckPlanRisk($project->id)}};-->
       <!--{{$project->runCheckPlanRiskTrian($project->id)}}-->
        {!!$projects->render()!!}

...
@section('content')
        ...
        <div class="col-sm-12 text-right">
           <a class="btn btn-info" href={{route('risktask.check', $risk->id)}} title="Check" ><i class="glyphicon glyphicon-check"></i></a>
           <br> <br>
        </div>
        <table class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <td class="button-center"><a class="btn btn-info" href="{{url('riskmanager/risktask/'.$subrisk->id.'/edit')}}" title="Editar" ><i class="glyphicon glyphicon-pencil"></i></a>
                </td> 
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <form method="post" action={{route('risktask.delete', $subrisk->id)}}>
                        {!! csrf_field() !!}
        ...
        <div class="row">
          <div class="col-md-12 text-right">
            ...
            <a href="{{route('riskmanager.risktask.indexRiskM')}}" class="btn btn-info">Regresar</a>
          </div>
        </div>

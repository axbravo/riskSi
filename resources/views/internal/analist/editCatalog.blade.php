...
@section('content')
        ...
        <div class="row">
          <div class="col-sm-8">
            {!!Form::open(array('route' => ['taskrisk.update',$risk->id],'files'=>true,'id'=>'form','class'=>'form-horizontal'))!!}
          ...
          @endif
              ...
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  ...
                  <a href="{{url('analista/taskrisk')}}"><button type="button" class="btn btn-info">Cancelar</button></a>
                </div>
              </div>

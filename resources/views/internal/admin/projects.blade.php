...
@section('content')
        <!-- Contenido-->
        <div class="row">
          {!!Form::open(array('url' => 'admin/projects' ,'id'=>'form','class'=>'form-horizontal'))!!}
        ...
        <table class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <td class="button-center"><a class="btn btn-info" href="{{url('admin/projects/'.$project->id.'/analyse')}}" title="Detalle" ><i class="glyphicon glyphicon-stats"></i></a>
                </td> 
                <td class="button-center"><a class="btn btn-info" href="{{url('admin/projects/'.$project->id.'/subactivities')}}" title="Detalle" ><i class="glyphicon glyphicon-plus"></i></a>
                </td> 
                <td class="button-center"><a class="btn btn-info" href="{{url('admin/projects/'.$project->id.'/edit')}}" title="Editar" ><i class="glyphicon glyphicon-pencil"></i></a>
                </td> 

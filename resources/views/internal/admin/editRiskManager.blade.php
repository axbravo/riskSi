...
@section('content')
        ...
        <div class="row">
          <div class="col-sm-8">
             {!!Form::open(array('url' => 'admin/riskmanager/'.$user->id.'/edit','files'=>true,'id'=>'form','class'=>'form-horizontal'))!!}
             {!!Form::hidden('id', $user->id)!!}
              ...
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  ...
                  <a class="btn btn-info" type="button" href=""  title="Create"  data-toggle="modal" data-target="#editModalRiskManager">Guardar</a>
                  <!-- <button type="submit" class="btn btn-info">Guardar</button> -->
                  <a href="{{url('admin/riskmanager')}}"><button type="button" class="btn btn-info">Cancelar</button></a>
               ...
               <!-- MODAL -->
              <div class="modal fade"  id="editModalRiskManager">
  ...
  <script>
    function justNumbers(){
     ...
     $("#botonModal").click(function(){
      $("#editModalRiskManager").modal('toggle');
    });
  </script>

...
@section('content')
        <!-- Contenido-->
        <div class="row">
                {!!Form::open(array('url' => 'admin/risk' ,'id'=>'form','class'=>'form-horizontal'))!!}
            <div class="col-sm-3">
                <hr style="margin:1px;">
        ...
        <table class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <td class="button-center"><a class="btn btn-info" href="{{url('admin/risk/'.$risk->id.'/subrisks')}}" title="Detalle" ><i class="glyphicon glyphicon-plus"></i></a>
                </td> 
                <td class="button-center"><a class="btn btn-info" href="{{url('admin/risk/'.$risk->id.'/edit')}}" title="Editar" ><i class="glyphicon glyphicon-pencil"></i></a>
                </td> 
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <form method="post" action={{route('risk.delete', $risk->id)}}>
                        {!! csrf_field() !!}

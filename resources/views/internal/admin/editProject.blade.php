...
@section('content')
        ...
        <div class="row">
          <div class="col-sm-8">
            {!!Form::open(array('route' => ['projects.update',$project->id],'files'=>true,'id'=>'form','class'=>'form-horizontal'))!!}
              ...
              <label class="col-sm-2" for="inputTime">Duración optimista</label>
              <div class="col-sm-10">
                {!! Form::number('minDuration','', array('class' => 'form-control','id' => 'inputminDuration','maxlength' => 50,'min' => '0')) !!}
              <br>
              </div>
              <label class="col-sm-2" for="inputTime">Duración pesimista</label>
              <div class="col-sm-10">
                {!! Form::number('maxDuration','', array('class' => 'form-control','id' => 'inputmaxDuration','maxlength' => 50,'min' => '0')) !!}
               <br>
              </div>   
              <div class="form-group">
          ...
          <div class="form-group">
              ...
              <div id="subactivityForm" class="collapse form-group @if ($project->type == 2) in @endif">
                ...
                <div class="col-sm-10">
                  {!! Form::select('father_id', $project_list->toArray(), $project->father_id, array('class' => 'form-control','id' => 'subactivity')) !!}
                  <br>
                </div>
                ...
                <div id="dependenceForm" class="collapse form-group @if (old('dependence_id') == '') $project->dependence_id=NULL in @endif">

...
@section('content')
        ...
        <div class="row">
          <div class="col-sm-8">
             {!!Form::open(array('url' => 'admin/portmanager/'.$user->id.'/edit','files'=>true,'id'=>'form','class'=>'form-horizontal'))!!}
             {!!Form::hidden('id', $user->id)!!}
              ...
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  ...
                  <a class="btn btn-info" type="button" href=""  title="Create"  data-toggle="modal" data-target="#editModalPortManager">Guardar</a>
                  <!-- <button type="submit" class="btn btn-info">Guardar</button> -->
                  <a href="{{url('admin/portmanager')}}"><button type="button" class="btn btn-info">Cancelar</button></a>
               ...
               <!-- MODAL -->
              <div class="modal fade"  id="editModalPortManager">
  ...
  <script>
    function justNumbers(){
     ...
     $("#botonModal").click(function(){
      $("#editModalPortManager").modal('toggle');
    });
  </script>

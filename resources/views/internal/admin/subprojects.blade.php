...
@section('content')
        ...
        <table class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <td class="button-center"><a class="btn btn-info" href="{{url('admin/projects/'.$subactivity->id.'/edit')}}" title="Editar" ><i class="glyphicon glyphicon-pencil"></i></a>
                </td> 
        ...
        <div class="row">
          <div class="col-md-12 text-right">
            <a href="{{route('admin.projects.indexAdmin')}}" class="btn btn-info">Regresar</a>
          </div>
        </div>
 <html>
  <head>

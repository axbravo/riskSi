...
@section('content')
        ...
        <div class="row">
          <div class="col-sm-8">
             {!!Form::open(array('url' => 'admin/riskresponsable/'.$user->id.'/edit','files'=>true,'id'=>'form','class'=>'form-horizontal'))!!}
             {!!Form::hidden('id', $user->id)!!}
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                {!!Form::select('role_id', ['1' => 'Responsable de Riesgos','2' => 'Gestor de Riesgos', '3' => 'Gestor de Portafolio', '4'=>'Administrador','5' => 'Analista'], null, ['class'=>'form-control','required'])!!}
                </div>
              </div>
              <!--
              <div class="form-group">
              ...
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  ...
                  <a class="btn btn-info" type="button" href=""  title="Create"  data-toggle="modal" data-target="#editModalRiskResponsable">Guardar</a>
                  <!-- <button type="submit" class="btn btn-info">Guardar</button> -->
                  <a href="{{url('admin/riskresponsable')}}"><button type="button" class="btn btn-info">Cancelar</button></a>
               ...
               <!-- MODAL -->
              <div class="modal fade"  id="editModalRiskResponsable">
  ...
  <script>
    function justNumbers(){
     ...
     $("#botonModal").click(function(){
      $("#editModalRiskResponsable").modal('toggle');
    });
  </script>

...
@section('content')
        ...
        <div class="col-sm-12 text-right">
           <a class="btn btn-info" href={{route('itemrisk.check', $risk->id)}} title="Check" ><i class="glyphicon glyphicon-check"></i></a>
           <br> <br>
        </div>
        <table class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <td>{{$subrisk->impact}}</td>
                <td>{{$subrisk->importance}}</td>
                <td>{{$subrisk->factor}}</td>
                <td>{{$subrisk->cost}}</td>
                <td>{{$subrisk->duration}}</td>
                <td class="button-center"><a class="btn btn-info" href={{route('itemrisk.edit', $subrisk->id)}} title="Editar" ><i class="glyphicon glyphicon-pencil"></i></a>
                </td> 
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <form method="post" action={{route('itemrisk.delete', $subrisk->id)}}>
                        {!! csrf_field() !!}
        ...
        <div class="row">
          <div class="col-md-12 text-right">
            ...
            <a href="{{route('itemrisk.indexPortM')}}" class="btn btn-info">Regresar</a>
          </div>
        </div>

...
@section('content')
        ...
        <div class="row">
          <div class="col-sm-8">
            {!!Form::open(array('route' => ['itemrisk.update',$risk->id],'files'=>true,'id'=>'form','class'=>'form-horizontal'))!!}
              ...
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                 <a href="portmanager/itemrisk/{id}/subrisks"></a> <button type="submit" class="btn btn-info">Guardar</button>
                  <a href="{{url('portmanager/itemrisk/'.$risk->id.'/subrisks')}}"><button type="button" class="btn btn-info">Cancelar</button></a>
                </div>
              </div>
